...
const style={
  wrapper:'relative flex cursor-pointer flex-col rounded-lg shadow-lg transition-all duration-300 hover:shadow-2xl dark:bg-gray-800 border hover:border-indigo-300 border-white',
  imageContainer:'h-3/4 overflow-hidden dark:bg-gray-800',
  nftImage:'rounded-t-lg object-cover scale-100 hover:scale-110 ease-in duration-200',
  ...
  priceTitle:` text-sm font-light`,
  wethImageContainer:'flex items-center justify-end',
