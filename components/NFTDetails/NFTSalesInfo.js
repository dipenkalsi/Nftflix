...
const NFTSalesInfo=({price,buyNFT,buttonLoading})=>{
    ...
    <div className={style.wrapper}>
      <div className={style.header}>
        ...
        <div className={style.greyText}>
          Last date to buy - {randomDate(new Date(2023, 9, 1), new Date()).toString().slice(0,16)}
        </div>
          </div>
        ...
        <div className={style.mainContainer}>
          <div className={style.priceInfo}>
            <div className={`${style.greyText} ${style.mediumFont}`}>Buy for</div>
            <div className={style.priceContainer}>
              <span className={style.price}>{price}</span>
              <Image src='/weth-logo.svg'
                width={24} height={24} alt="weth"/>
            </div>
          </div>
