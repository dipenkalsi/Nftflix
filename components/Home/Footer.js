...
const Footer = () => {
  return (
    <footer className="relative z-10 px-5 pt-20 pb-10 lg:pt-[120px] lg:pb-20 text-center max-w-6xl mx-auto">
    ...
    <div className="-mx-4 flex flex-wrap">
      <div className="w-full px-4 sm:w-2/3 lg:w-3/12">
        <div className="mb-10 w-full">
          ...
          <p className="text-body-color mb-7 text-base">
            This is an NFT marketPlace application team exabyte created at hackCBS5.0.
          </p>
          <p className="text-dark flex items-center text-sm font-medium justify-center">
      ...
      <div className="w-full px-4 sm:w-1/2 lg:w-3/12">
        <div className="mb-10 w-full">
          ...
          <p className="text-body-color text-base">&copy; 2025 NFTFLIX. All rights reserved</p>
        </div>
      </div>
    </div>
  </div>
